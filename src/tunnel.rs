...
use crate::socks5_uplink::Socks5Uplink;

/// Abstract sender for outgoing tunnel packets.
pub enum OutboundTransport {
    /// Client-side uplink via SOCKS5 UDP relay.
    Socks5Uplink {
        relay: Arc<Socks5Uplink>,
...
impl TunnelManager {
    pub fn new(outbound: OutboundTransport, mtu: usize, initial_cwnd: f64) -> Self {
        Self(Arc::new(Inner {
            tunnels:               DashMap::new(),
